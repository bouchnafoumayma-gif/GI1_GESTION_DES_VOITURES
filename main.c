...
int main() {
    ...
    // Texte blanc � l'int�rieur du cadre
    printf(WHITE);
   ...
   /* printf(BLUE"*******************************************BONJOUR!******************************\n"RESET);
    ...
    scanf("%d", &A);*/
  // PAGE 1 : Menu principal styl� avec curseur
...
do {
    ...
    printf(BLUE);
    printf("||-----------------------------------------------------------------------------------------||\n");
    printf("||      Utilisez les fl�ches pour naviguer et Entr�e pour valider votre choix.             ||\n");
    printf("=============================================================================================\n");
    printf(RESET);

    touche = _getch();
    if (touche == 72) { // fl�che haut
        if (choixMenu > 0) choixMenu--;
    } else if (touche == 80) { // fl�che bas
        if (choixMenu < 2) choixMenu++;
    }

} while (touche != 13); // 13 = Entr�e

A = choixMenu + 1; // 1 = Employ�, 2 = Client, 3 = Quitter
#ifdef _WIN32
system("cls");
#else
system("clear");
